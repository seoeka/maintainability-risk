...
describe('astUtils', () => {
  ...
  it('should collect analyzable functions including nested functions', () => {
    const program = parseProgram(`
      function first() {
        function nested() {
          return true;

...
function isSupportedJavaScriptDocument(
...
export function analyzeTextDocument(
  ...
  try {
    ...
    const dependencyResult =
      analyzeDependencies(programNode);

    const functions =
      collectAnalyzableFunctions(programNode);

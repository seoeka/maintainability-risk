...
exports.explainWithLLM = explainWithLLM;
exports.testLLMProxy = testLLMProxy;
...
function deterministicFallback(fn, technicalNote) {
    return {
...
function createProxyPayload(fn, settings) {
    return {
...
function extractExplanation(json, fn) {
    if (!json || typeof json !== 'object') {
        return undefined;
    }
    ...
    const hasStructuredFields = typeof json.summary === 'string' ||

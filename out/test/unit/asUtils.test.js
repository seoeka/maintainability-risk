...
(0, node_test_1.describe)('astUtils', () => {
    (0, node_test_1.it)('should identify function nodes', () => {
    ...
    (0, node_test_1.it)('should return false for non-function nodes', () => {
        const program = parseProgram(`
      const value = 10;
    `);
    ...
    (0, node_test_1.it)('should walk all relevant AST nodes', () => {
        const program = parseProgram(`
    ...
    (0, node_test_1.it)('should collect top-level functions', () => {
        const program = parseProgram(`
      function first() {
        function nested() {
          return true;
    ...
    `);
        ...
        const functions = (0, astUtils_1.collectTopLevelFunctions)(program);
        node_assert_1.default.strictEqual(functions.length, 2);
        node_assert_1.default.strictEqual(functions[0].id.name, 'first');
        node_assert_1.default.strictEqual(functions[1].id.name, 'second');
    });
    (0, node_test_1.it)('should attach parent nodes to AST nodes', () => {
        const program = parseProgram(`
      function hello() {
        return 1;
      }
    ...
    (0, node_test_1.it)('should get function declaration name', () => {
        const program = parseProgram(`
      function calculate() {
        return 1;
      }
    ...
    (0, node_test_1.it)('should get arrow function name from variable declaration', () => {
        const program = parseProgram(`
      const calculate = () => {
        return 1;
      };
    ...
    (0, node_test_1.it)('should generate fallback name for anonymous function', () => {
        const program = parseProgram(`
      [1].map(function () {
        return 1;
      });
...
//# sourceMappingURL=asUtils.test.js.map